...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    JComboBox comboid;
    JTextField tfnumber,tfaddress, username,tfcountry, tfemail, tfphone;
    JRadioButton rmale,rfemale;
    JButton add,back;
    
    AddCustomer(String username){
        JTextField tfusername = new JTextField(username);
tfusername.setBounds(160, 50, 200, 25);
add(tfusername);
...
String query = "insert into customer values('" + username + "', '" + id + "', '" + number + "', '" + name + "', '" + gender + "', '" + country + "', '" + address + "', '" + phone + "', '" + email + "')";
               ...
               JOptionPane.showMessageDialog(null,"Customber Details Added Successsfully");
               setVisible(false);
            }catch(Exception e){
                e.printStackTrace();
            }
